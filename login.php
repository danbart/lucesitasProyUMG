...
$layout = new TLayout("login2", "FancyCoral", "MobileCoral");
$layout->version = 2;
...
if(@$_GET["message"] == "expired")
	$message = "Su sesión ha expirado." . "Por favor, identifíquese de nuevo.";
...
if ($onFly == 2)
{
	...
	if (($pageObject->isCaptchaOk == 0) && ($useCaptcha)) {
		$returnJSON['message'] = "Codigo de seguridad no válido";
	}
