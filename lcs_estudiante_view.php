...
$page_layouts["lcs_estudiante_view"] = $layout;
...
$keys = array();
$keys["Nombre"] = postvalue("editid1");
$keys["Apellido"] = postvalue("editid2");
$keys["Direcccion"] = postvalue("editid3");
$keys["FNacimiento"] = postvalue("editid4");
$keys["FotoRostro"] = postvalue("editid5");
$keys["Ingresado"] = postvalue("editid6");
$keys["_idCentro"] = postvalue("editid7");
