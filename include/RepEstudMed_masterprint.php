<?php
function DisplayMasterTableInfoForPrint_RepEstudMed($params)
{
	global $cman;
	...
	if( $detailtable == "lcs_descsocial" )
	{
		...
		$showKeys.= " ".GetFieldLabel("RepEstudMed","idEstudiante").": ".$keyValue;
	...
	$layout = GetPageLayout("RepEstudMed", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("RepEstudMed", "masterprint"));
}
