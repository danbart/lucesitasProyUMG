...
require_once("include/lcs_userslogin_variables.php");
...
$page_layouts["lcs_userslogin_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "lcs_userslogin" );
