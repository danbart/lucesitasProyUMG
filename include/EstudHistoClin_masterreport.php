<?php
function DisplayMasterTableInfo_EstudHistoClin($params)
{
	global $cman;
	...
	$xt->assign("AdaptSocial_class", $class); // add class for field header as field value
		$xt->assign("Documento_mastervalue", "<span class='rnr-field-file'>".$viewControls->showDBValue("Documento", $data, $keylink)."</span>");
	...
	$layout = GetPageLayout("EstudHistoClin", "masterreport");
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');
	
	$xt->displayPartial(GetTemplateName("EstudHistoClin", "masterreport"));
}
?>