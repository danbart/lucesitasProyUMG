<?php
function DisplayMasterTableInfoForPrint_EstuHistLengua($params)
{
	global $cman;
	...
	$layout = GetPageLayout("EstuHistLengua", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("EstuHistLengua", "masterprint"));
}
