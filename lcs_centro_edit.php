...
require_once("include/lcs_centro_variables.php");
...
$page_layouts["lcs_centro_edit"] = $layout;
...
$keys = array();
$keys["idCentro"] = postvalue("editid1");
$keys["Nombre"] = postvalue("editid2");
$keys["Dirección"] = postvalue("editid3");
$keys["Telefono"] = postvalue("editid4");
$keys["Propietario"] = postvalue("editid5");
$keys["Responsable"] = postvalue("editid6");
$keys["Ingresado"] = postvalue("editid7");
