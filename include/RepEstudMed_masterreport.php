<?php
function DisplayMasterTableInfo_RepEstudMed($params)
{
	global $cman;
	...
	$layout = GetPageLayout("RepEstudMed", "masterreport");
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');
	
	$xt->displayPartial(GetTemplateName("RepEstudMed", "masterreport"));
}
?>