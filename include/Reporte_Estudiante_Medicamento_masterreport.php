<?php
function DisplayMasterTableInfo_Reporte_Estudiante_Medicamento($params)
{
	global $cman;
	...
	$layout = GetPageLayout("Reporte_Estudiante_Medicamento", "masterreport");
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');
	
	$xt->displayPartial(GetTemplateName("Reporte_Estudiante_Medicamento", "masterreport"));
}
?>