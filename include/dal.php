...
class tDAL
{
	...
	var $lcs_emociones;
	var $lcs_encargado;
	var $lcs_enfermedades;
	var $lcs_espemed;
	var $lcs_estudiante;
	var $lcs_histoiralfamiliar;
	var $lcs_historialclinico;
	var $lcs_lenguaje;
	var $lcs_medicamento;
	var $lcs_personal;
	var $lcs_sesion;
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "lcs_centro", "varname" => "lcs_centro", "connId" => "Tables");
		$this->lstTables[] = array("name" => "lcs_descsocial", "varname" => "lcs_descsocial", "connId" => "Tables");
		$this->lstTables[] = array("name" => "lcs_donaciones", "varname" => "lcs_donaciones", "connId" => "Tables");
		$this->lstTables[] = array("name" => "lcs_embarazo", "varname" => "lcs_embarazo", "connId" => "Tables");
		$this->lstTables[] = array("name" => "lcs_emociones", "varname" => "lcs_emociones", "connId" => "Tables");
		$this->lstTables[] = array("name" => "lcs_encargado", "varname" => "lcs_encargado", "connId" => "Tables");
		$this->lstTables[] = array("name" => "lcs_enfermedades", "varname" => "lcs_enfermedades", "connId" => "Tables");
		$this->lstTables[] = array("name" => "lcs_espemed", "varname" => "lcs_espemed", "connId" => "Tables");
		$this->lstTables[] = array("name" => "lcs_estudiante", "varname" => "lcs_estudiante", "connId" => "Tables");
		$this->lstTables[] = array("name" => "lcs_histoiralfamiliar", "varname" => "lcs_histoiralfamiliar", "connId" => "Tables");
		$this->lstTables[] = array("name" => "lcs_historialclinico", "varname" => "lcs_historialclinico", "connId" => "Tables");
