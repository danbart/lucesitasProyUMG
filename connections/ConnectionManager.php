...
class ConnectionManager
{
	...
	protected function _setConnectionsData()
	{
		...
		$data["dbType"] = 0;
		$data["connId"] = "Tables";
		$data["connName"] = "Lucecitas";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;danilosolos;3306;db_edee_lucesita;;1"; //currently unused
...
;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["lcs_tiposocial"] = "Tables";
		$connectionsIds["lcs_transtornoalimenticio"] = "Tables";
		$connectionsIds["lcs_transtornoesfinteres"] = "Tables";
		$connectionsIds["lcs_trastornosuenio"] = "Tables";
		$connectionsIds["lcs_lenguaje"] = "Tables";
		$connectionsIds["lcs_historialclinico"] = "Tables";
		$connectionsIds["lcs_histoiralfamiliar"] = "Tables";
		$connectionsIds["lcs_enfermedades"] = "Tables";
		$connectionsIds["lcs_embarazo"] = "Tables";
		$connectionsIds["lcs_espemed"] = "Tables";
		$connectionsIds["lcs_descsocial"] = "Tables";
		$connectionsIds["lcs_encargado"] = "Tables";
		...
		$connectionsIds["TranstornosAlimenticio"] = "Tables";
		$connectionsIds["EstuHistLengua"] = "Tables";
		$connectionsIds["TranstornosEsfinteres"] = "Tables";
		$connectionsIds["TranstornosSueno"] = "Tables";
