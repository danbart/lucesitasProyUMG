<?php
function DisplayMasterTableInfo_lcs_personal($params)
{
	global $cman;
	...
	$layout = GetPageLayout("lcs_personal", 'masterlist');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');
	
	$xt->displayPartial(GetTemplateName("lcs_personal", "masterlist"));
}
