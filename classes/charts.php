...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("lcs_terapista" == $this->chrt_array['tables'][0])
			return true;
		if("lcs_tiposocial" == $this->chrt_array['tables'][0])
			return true;
		if("lcs_transtornoalimenticio" == $this->chrt_array['tables'][0])
			return true;
		if("lcs_transtornoesfinteres" == $this->chrt_array['tables'][0])
			return true;
		if("lcs_trastornosuenio" == $this->chrt_array['tables'][0])
			return true;
		if("lcs_lenguaje" == $this->chrt_array['tables'][0])
			return true;
		if("lcs_historialclinico" == $this->chrt_array['tables'][0])
			return true;
		if("lcs_histoiralfamiliar" == $this->chrt_array['tables'][0])
			return true;
		if("lcs_enfermedades" == $this->chrt_array['tables'][0])
			return true;
		if("lcs_embarazo" == $this->chrt_array['tables'][0])
			return true;
		if("lcs_espemed" == $this->chrt_array['tables'][0])
			return true;
		if("lcs_descsocial" == $this->chrt_array['tables'][0])
			return true;
		if("lcs_encargado" == $this->chrt_array['tables'][0])
			return true;
		if("lcs_emociones" == $this->chrt_array['tables'][0])
			return true;
		if("lcs_medicamento" == $this->chrt_array['tables'][0])
			return true;
