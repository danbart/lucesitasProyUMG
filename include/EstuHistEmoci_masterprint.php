<?php
function DisplayMasterTableInfoForPrint_EstuHistEmoci($params)
{
	global $cman;
	...
	$layout = GetPageLayout("EstuHistEmoci", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("EstuHistEmoci", "masterprint"));
}
