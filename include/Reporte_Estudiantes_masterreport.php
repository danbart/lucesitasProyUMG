<?php
function DisplayMasterTableInfo_Reporte_Estudiantes($params)
{
	global $cman;
	...
	$layout = GetPageLayout("Reporte_Estudiantes", "masterreport");
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');
	
	$xt->displayPartial(GetTemplateName("Reporte_Estudiantes", "masterreport"));
}
?>