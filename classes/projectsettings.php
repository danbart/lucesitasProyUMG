...
function GetTableURL($table = "")
{
	...
	if("lcs_terapias" == $table) 
		return "lcs_terapias";
	if("lcs_terapista" == $table) 
		return "lcs_terapista";
	if("lcs_tiposocial" == $table) 
		return "lcs_tiposocial";
	if("lcs_transtornoalimenticio" == $table) 
		return "lcs_transtornoalimenticio";
	if("lcs_transtornoesfinteres" == $table) 
		return "lcs_transtornoesfinteres";
	if("lcs_trastornosuenio" == $table) 
		return "lcs_trastornosuenio";
	if("lcs_lenguaje" == $table) 
		return "lcs_lenguaje";
	if("lcs_historialclinico" == $table) 
		return "lcs_historialclinico";
	if("lcs_histoiralfamiliar" == $table) 
		return "lcs_histoiralfamiliar";
	if("lcs_enfermedades" == $table) 
		return "lcs_enfermedades";
	if("lcs_embarazo" == $table) 
		return "lcs_embarazo";
	if("lcs_espemed" == $table) 
		return "lcs_espemed";
	if("lcs_descsocial" == $table) 
		return "lcs_descsocial";
	if("lcs_encargado" == $table) 
		return "lcs_encargado";
	if("lcs_emociones" == $table) 
		return "lcs_emociones";
	if("lcs_medicamento" == $table) 
	...
	if("RepEstudMed" == $table) 
		return "RepEstudMed";
	if("EstuHistSocial" == $table) 
		return "EstuHistSocial";
	if("TranstornosAlimenticio" == $table) 
		return "TranstornosAlimenticio";
	if("EstuHistLengua" == $table) 
		return "EstuHistLengua";
	if("TranstornosEsfinteres" == $table) 
		return "TranstornosEsfinteres";
	if("TranstornosSueno" == $table) 
		return "TranstornosSueno";
	if("EstuHistEmoci" == $table) 
		return "EstuHistEmoci";
	if("EstuHistEmbarazo" == $table) 
...
{	
	...
	if("lcs_terapias" == $shortTName) 
		return "lcs_terapias";
	if("lcs_terapista" == $shortTName) 
		return "lcs_terapista";
	if("lcs_tiposocial" == $shortTName) 
		return "lcs_tiposocial";
	if("lcs_transtornoalimenticio" == $shortTName) 
		return "lcs_transtornoalimenticio";
	if("lcs_transtornoesfinteres" == $shortTName) 
		return "lcs_transtornoesfinteres";
	if("lcs_trastornosuenio" == $shortTName) 
		return "lcs_trastornosuenio";
	if("lcs_lenguaje" == $shortTName) 
		return "lcs_lenguaje";
	if("lcs_historialclinico" == $shortTName) 
		return "lcs_historialclinico";
	if("lcs_histoiralfamiliar" == $shortTName) 
		return "lcs_histoiralfamiliar";
	if("lcs_enfermedades" == $shortTName) 
		return "lcs_enfermedades";
	if("lcs_embarazo" == $shortTName) 
		return "lcs_embarazo";
	if("lcs_espemed" == $shortTName) 
		return "lcs_espemed";
	if("lcs_descsocial" == $shortTName) 
		return "lcs_descsocial";
	if("lcs_encargado" == $shortTName) 
		return "lcs_encargado";
	if("lcs_emociones" == $shortTName) 
		return "lcs_emociones";
	if("lcs_medicamento" == $shortTName) 
		return "lcs_medicamento";
	...
	if("RepEstudMed" == $shortTName) 
		return "RepEstudMed";
	if("EstuHistSocial" == $shortTName) 
		return "EstuHistSocial";
	if("TranstornosAlimenticio" == $shortTName) 
		return "TranstornosAlimenticio";
	if("EstuHistLengua" == $shortTName) 
		return "EstuHistLengua";
	if("TranstornosEsfinteres" == $shortTName) 
		return "TranstornosEsfinteres";
	if("TranstornosSueno" == $shortTName) 
		return "TranstornosSueno";
	if("EstuHistEmoci" == $shortTName) 
		return "EstuHistEmoci";
	if("EstuHistEmbarazo" == $shortTName) 
		return "EstuHistEmbarazo";
