...
$page_layouts["lcs_medicamento_print"] = $layout;
...
$page_layouts["lcs_enfermedades_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "lcs_medicamento" );
