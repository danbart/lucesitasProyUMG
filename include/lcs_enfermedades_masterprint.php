<?php
function DisplayMasterTableInfoForPrint_lcs_enfermedades($params)
{
	global $cman;
	...
	$layout = GetPageLayout("lcs_enfermedades", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("lcs_enfermedades", "masterprint"));
}
