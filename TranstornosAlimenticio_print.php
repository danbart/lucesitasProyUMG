...
require_once("include/TranstornosAlimenticio_variables.php");
...
$page_layouts["TranstornosAlimenticio_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=TranstornosAlimenticio.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=TranstornosAlimenticio.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
