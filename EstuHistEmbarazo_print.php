...
require_once("include/EstuHistEmbarazo_variables.php");
...
$page_layouts["EstuHistEmbarazo_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=EstuHistEmbarazo.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=EstuHistEmbarazo.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("MesesNac_fieldheader", true);
$xt->assign("TipoParto_fieldheader", true);
$xt->assign("AbortosAnt_fieldheader", true);
$xt->assign("Emorragias_fieldheader", true);
$xt->assign("infecciones_fieldheader", true);
$xt->assign("LloroPronto_fieldheader", true);
$xt->assign("RespiroPronto_fieldheader", true);
$xt->assign("ColorNacido_fieldheader", true);
$xt->assign("SufrimientoFetal_fieldheader", true);
$xt->assign("EmbDeseado_fieldheader", true);
$xt->assign("Embarazocol_fieldheader", true);
...
if($mastertable == "lcs_centro")
{
	...
	$dparams = array("detailtable" => "EstuHistEmbarazo", "keys" => $masterkeys);
	$master = array(); 
