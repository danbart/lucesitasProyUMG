...
require_once("include/TranstornosEstudiante_variables.php");
...
$page_layouts["TranstornosEstudiante_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=TranstornosEstudiante.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=TranstornosEstudiante.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("TipoTAlimenticio_fieldheader", true);
