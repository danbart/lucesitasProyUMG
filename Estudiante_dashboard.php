...
require_once("include/Estudiante_variables.php");





$layout = new TLayout("dashboard", "FusionAvenue", "MobileAvenue");
$layout->version = 2;
...
$page_layouts["Estudiante_dashboard"] = $layout;
...
$params["templatefile"] = GetTemplateName("Estudiante", "dashboard");
