<?php
function DisplayMasterTableInfo_lcs_estudiante($params)
{
	global $cman;
	...
	$layout = GetPageLayout("lcs_estudiante", 'masterlist');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');
	
	$xt->displayPartial(GetTemplateName("lcs_estudiante", "masterlist"));
}
