...
require_once("include/Reporte_Estudiante_Medicamento_variables.php");
...
$page_layouts["Reporte_Estudiante_Medicamento_rprint"] = $layout;
...
if (@$_REQUEST["format"] == "excel")
{
	...
	header("Content-Disposition: attachment;Filename=Reporte_Estudiante_Medicamento.xls");
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Reporte_Estudiante_Medicamento.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("TipoMedicamento_fieldheader", true);
$xt->assign("NombreMed_fieldheader", true);
$xt->assign("Hora_fieldheader", true);
$xt->assign("FotoRostro_fieldheader", true);
$xt->assign("TipoEnfermedad_fieldheader", true);
$xt->assign("dias_fieldheader", true);
$xt->assign("Dosis_fieldheader", true);
...
if($mastertable == "lcs_centro")
{
	...
	$dparams = array("detailtable" => "Reporte Estudiante Medicamento", "keys" => $masterkeys);
	$master = array(); 
