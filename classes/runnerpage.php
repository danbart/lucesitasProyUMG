...
class RunnerPage
{
	...
	*/
	...
	{
		if( $page == "add" )
			return GetTableCaption($table).", "."Añadir nuevo registro";
		if( $page == "edit" )
			return GetTableCaption($table).", "."Editar registro"." [". $this->getKeysTitleTemplate( $table, $pSet ). "]";
		if( $page == "view" )
			return GetTableCaption($table).", "."Ver registro"." [". $this->getKeysTitleTemplate( $table, $pSet ). "]";
		if( $page == "export" )
			return "Exportar";
		if( $page == "import" )
