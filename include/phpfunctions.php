...
function fileCustomExpression($file, $data, $field, $ptype, $table="")
{
	...
	if(!$table)
		$table = $strTableName;
				if($table=="lcs_historialclinico" && $field=="Documento")
	{
		;
		return $value;
	}	
...
function GetDefaultValue($field, $ptype, $table="")
{
				...
				if($table=="lcs_estudiante" && $field=="Ingresado") 
	{
		return 300;
				...
				if($table=="lcs_lenguaje" && $field=="Balbucea") 
	{
		return 0;
	}
				if($table=="lcs_histoiralfamiliar" && $field=="DuermeSolo") 
	{
		return 0;
	}
				if($table=="lcs_histoiralfamiliar" && $field=="ComparteCuarto") 
	{
		return 0;
	}
				if($table=="lcs_histoiralfamiliar" && $field=="ParineteIgual") 
	{
		return 0;
	}
				if($table=="lcs_embarazo" && $field=="RespiroPronto") 
	{
		return 0;
	}
				if($table=="lcs_embarazo" && $field=="SufrimientoFetal") 
	{
		return 0;
	}
				if($table=="EstuHistLengua" && $field=="Ingresado") 
	{
		return 300;
	}
				if($table=="EstuHistEmoci" && $field=="Ingresado") 
	{
		return 300;
	}
				if($table=="EstuHistEmbarazo" && $field=="Ingresado") 
	{
		return 300;
	}
				if($table=="EstuHistCaracter" && $field=="Ingresado") 
	{
		return 300;
	}
	return "";
