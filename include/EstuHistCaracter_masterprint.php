<?php
function DisplayMasterTableInfoForPrint_EstuHistCaracter($params)
{
	global $cman;
	...
	$layout = GetPageLayout("EstuHistCaracter", 'masterprint');
	if( $layout )
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');

	$xt->displayPartial(GetTemplateName("EstuHistCaracter", "masterprint"));
}
