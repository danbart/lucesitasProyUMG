...
require_once("include/Reporte_Estudiantes_variables.php");
...
$page_layouts["Reporte_Estudiantes_rprint"] = $layout;
...
else if (@$_REQUEST["format"] == "word")
{
	...
	header("Content-Disposition: attachment;Filename=Reporte_Estudiantes.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
...
$xt->assign("Rostro_fieldheader", true);
$xt->assign("Terapia_fieldheader", true);
$xt->assign("Nombre_Terapista_fieldheader", true);
...
if($mastertable == "lcs_centro")
{
	...
	$dparams = array("detailtable" => "Reporte Estudiantes", "keys" => $masterkeys);
	$master = array(); 
